        ...
        <div class="input-forms">
            ...
            <form action="{{ route('auth.confirm') }}" name="confirm" method="post">
                ...
                <div class="form-group field">
                    ...
                    <input type="text" name="user_name" class="form-field" placeholder=" " id='name' maxlength="50" required value="{{old('user_name')}}" />
                ...
                <div class="form-group field">
                    ...
                    <input type="email" name="mail_address" class="form-field" placeholder=" " id='email' maxlength="50" required value="{{old('mail_address')}}" />
                ...
                <div>
                    ...
                    <div class="form-group field date">
                        <input type="text" name="user_birthdate_y" value="{{old('user_birthdate_y')}}" class="form-field date" placeholder=" " id='birthyear' value="" maxlength="4" required />
                        <label for="birthyear" class="form-label">YYYY</label>
                    </div>
                    <!--月-->
                    <div class="form-group field  date">
                        <input type="text" name="user_birthdate_m" value="{{old('user_birthdate_m')}}" class="form-field date" placeholder=" " id='birthmonth' value="" maxlength="2" required />
                        <label for="birthmonth" class="form-label">MM</label>
                    </div>
                    <!--日-->
                    <div class="form-group field  date">
                        <input type="text" name="user_birthdate_d" value="{{old('user_birthdate_d')}}" class="form-field date" placeholder=" " id='birthday' value="" maxlength="2" required />
                ...
                <div class="form-group field">
                    ...
                    <input type="password" name="password" class="form-field" placeholder=" " id='pass' minlength="8" maxlength="50" required />
